    ...
    <SmoothScroll>
      ...
      <div className="h-full w-full px-10">
        <div className="flex flex-col hsm:flex-row mt-20 gap-10">
          <div className="relative ml-4 shadow-2xl rounded-2xl">
            <div className="absolute bg-[#768a20]/40 z-0 -translate-y-4 -translate-x-4 w-full h-full rounded-2xl"></div>
            <Image src='/NACA.png' alt="NACA" width={690} height={464} className="rounded-2xl relative z-10 not-md:w-full not-md:h-auto object-contain md:object-cover"/>
          </div>
          <div className="w-fit flex flex-col hsm:min-w-3xs">
            ...
            <Button position="hsm:mt-auto mt-10 content-center" font="font-quicksand">
      ...
      <div className="h-screen w-full px-10 bg-[#768a20]"></div>
    </SmoothScroll>
  );
}
